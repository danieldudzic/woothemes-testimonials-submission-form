...
class Submission_Form {
	...
	/**
	 * Submission form response items.
	 * @var     array
	 * @access  public
	 * @since   1.0.0
	 */
	...
	/**
	 * Post ID of the created Testimonial item.
	 * @var     mixed     The ID of the post if the testimonial is successfully added to the database. On failure, it returns 0 if $wp_error is set to false, or a WP_Error object if $wp_error is set to true.
	 * @access  public
	 * @since   1.0.0
	 */
